...
This file is a sample article demonstrating Quarto's capabilities with
the standard LaTeX \texttt{article} document class. It supports PDF (via
LaTeX) output. It is assumed that the reader has a basic working
knowledge of stochastic calculus \citet{karatzas1991brownian} and
stochastic control theory \citet{yong1999sch}.
